...
define(function(require) {
  "use strict";
    ...
    console.log("Render  - STEP!");
	  ...
	  // Scene translation --> Scene visible area
    this._ctx.translate(this._viewModel.cameraPosition[0], 
                        this._viewModel.cameraPosition[1]);
    // Dimetric basic transformations
